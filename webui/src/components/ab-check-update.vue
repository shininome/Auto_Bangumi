...
async function performUpdate() {
  ...
  // 构造GitHub release下载URL: app-v{version}.zip
  const downloadUrl = `https://github.com/shinonomeow/Auto_Bangumi/releases/download/${updateInfo.value.latest_version}/app-v${updateInfo.value.latest_version}.zip`;
  await executeUpdate(downloadUrl);
}
